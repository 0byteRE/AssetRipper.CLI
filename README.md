...
This fork contains modified version that works as CLI (AKA, in console). All credit goes to the original authors of [AssetRipper](https://github.com/AssetRipper/AssetRipper).
